...
# Run from the scenarios/basic directory
...
# Path to raggrep CLI (two levels up from scenarios/basic)
...
run_test() {
    ...
    # Get top 3 results
    results=$($RAGGREP query "$query" --top 3 2>/dev/null | grep -E "^[123]\." || echo "No results")
...
$RAGGREP index 2>/dev/null | tail -3
echo ""
...
echo "========================================"
echo ""
echo "To add new tests, edit this script or test-queries.md"
echo "For more info, see scenarios/README.md"
