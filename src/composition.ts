 ...
 */
export function createIndexDependencies(
 ...
 */
export function createCleanupDependencies(
  container: ServiceContainer
...
export function createSearchContext(
  ...
  return {
    rootDir,
    config,
    loadFileIndex: (filepath: string) =>
      storage.loadFileIndex(moduleId, filepath),
