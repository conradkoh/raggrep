 ...
 */
export class XenovaTransformersEmbeddingProvider implements EmbeddingProvider {
...
export const TransformersEmbeddingProvider = XenovaTransformersEmbeddingProvider;
